 ...
 */
export function buildUrl(path: string, useAbsolute: boolean = false): string {
...
export const ROUTES = {
  HOME: buildUrl("", true),
  PORFOLIO: buildUrl(""),
  PROYECTS: buildUrl("proyectos/"),
  CONTACT: buildUrl("contacto/"),
  GITHUB_PROFILE: "https://github.com/yaqui-sieras/",
} as const;
...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  { label: "GitHub", href: ROUTES.GITHUB_PROFILE },
] as const;
